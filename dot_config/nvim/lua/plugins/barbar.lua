return {
  ...
  config = function(_, opts)
    ...
    vim.keymap.set('n', '<M-S-,>', '<Cmd>BufferMovePrevious<CR>', { unpack(keyopts), desc='Move buffer to previous positon' })
    vim.keymap.set('n', '<M-S-.>', '<Cmd>BufferMoveNext<CR>', { unpack(keyopts), desc='Move buffer to next positon' })
    ...
    vim.keymap.set('n', '<leader>bb', '<Cmd>BufferOrderByBufferNumber<CR>', { unpack(keyopts), desc='Order buffers by number' })
    vim.keymap.set('n', '<leader>bn', '<Cmd>BufferOrderByName<CR>', { unpack(keyopts), desc='Order buffers by name' })
    vim.keymap.set('n', '<leader>bd', '<Cmd>BufferOrderByDirectory<CR>', { unpack(keyopts), desc='Order buffers by directory' })
    vim.keymap.set('n', '<leader>bl', '<Cmd>BufferOrderByLanguage<CR>', { unpack(keyopts), desc='Order buffers by language' })
    vim.keymap.set('n', '<leader>bw', '<Cmd>BufferOrderByWindowNumber<CR>', { unpack(keyopts), desc='Order buffers by window number' })
